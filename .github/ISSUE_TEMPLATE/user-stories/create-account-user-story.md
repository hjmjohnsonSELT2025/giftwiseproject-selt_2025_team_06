...
<span style="color:#3a86ff;">When</span> I am on the **create account page**<br>
<span style="color:#3a86ff;">And</span> I enter my username as <span style="color:#3a8600;">Username56</span><br>
<span style="color:#3a86ff;">And</span> I enter my password as <span style="color:#3a8600;">pass</span><br>
<span style="color:#3a86ff;">Then</span> I press the **“Submit”** button<br>
...
<span style="color:#3a86ff;">When</span> I am on the **create account page**<br>
<span style="color:#3a86ff;">And</span> I enter my username as <span style="color:#3a8600;">Username56</span><br>
<span style="color:#3a86ff;">And</span> I leave the password empty<br>
<span style="color:#3a86ff;">Then</span> I press the **“Submit”** button<br>
<span style="color:#3a86ff;">Then</span> I should get an error: **"Password invalid"**
...
<span style="color:#3a86ff;">When</span> I am on the **create account page**<br>
<span style="color:#3a86ff;">And</span> I enter my username as <span style="color:#3a8600;">Username56</span><br>
<span style="color:#3a86ff;">And</span> I enter my password as <span style="color:#3a8600;">Password56</span><br>
<span style="color:#3a86ff;">And</span> I leave the DOB empty<br>
<span style="color:#3a86ff;">Then</span> I press the **“Submit”** button<br>
...
<span style="color:#3a86ff;">When</span> I am on the **create account page**<br>
<span style="color:#3a86ff;">And</span> I enter my username as <span style="color:#3a8600;">Username65</span><br>
<span style="color:#3a86ff;">And</span> I enter my password as <span style="color:#3a8600;">Password56</span><br>
<span style="color:#3a86ff;">And</span> I leave the hobbies empty<br>
<span style="color:#3a86ff;">Then</span> I press the **“Submit”** button<br>
...
<span style="color:#3a86ff;">And</span> I enter my username as <span style="color:#3a8600;">Username65</span><br>
<span style="color:#3a86ff;">And</span> I enter my password as <span style="color:#3a8600;">Password56</span><br>
<span style="color:#3a86ff;">And</span> I leave the occupation box empty<br>
<span style="color:#3a86ff;">Then</span> I press the **“Submit”** button<br>
<span style="color:#3a86ff;">Then</span> I should be taken to the **home page**<br>
